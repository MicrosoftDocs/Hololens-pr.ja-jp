...
## <a name="environment-management"></a>接続管理
...
1. 上記のガイドラインに従い、予期しない過熱の問題が発生する場合は、フィードバックを送信する前に、完全/オプションの利用統計情報が有効になっている必要 [があります](hololens-feedback.md)。 オーバーヒートの問題を調査するには、完全/オプションのテレメトリが必要です。
